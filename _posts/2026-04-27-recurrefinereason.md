...
Establishing such a hierarchy naturally raises the question of resource allocation: if the model possesses different levels of abstraction, must every input pass through every level? This leads us directly to the concept of conditional computation.
